...
public class DrumSounds {
    ...
    public static String[] audioNames = new String[]{"HiHat.wav", "BassDrum.wav", "Snare.wav","Clap.wav", "MedTom.wav", "HiTom.wav", "LowTom.wav", "RideCymbal.wav", "Crash.wav", "Snap.wav"};
